...
#Drawing the Pet in where the y axis increase in numaric value when going down
#x axis grows in value when going from left to right in normal fasion like on
#a normal x y axis
...
#Foot motion for later on
#foot_left = c.create_oval(65, 380, 145, 265, outline = c.body_color, fill = c.body_color)
#foot_right = c.create_oval(250, 320, 330, 360, outline = c.body_color, fill = c.body_color)
...
check_left = c.create_oval(70, 180, 120, 230, outline = 'pink', fill = 'pink',
state = HIDDEN)
check_right = c.create_oval(280, 180, 330, 230, outline = 'pink', fill = 'pink',
state = HIDDEN)
